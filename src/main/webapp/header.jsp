...
<head>
    ...
    <!-- Plugin CSS -->
    <link href="<c:url value="vendor/magnific-popup/magnific-popup.css" />" rel="stylesheet">

    <!-- Theme CSS -->
    <link href="<c:url value="css/creative.min.css" />" rel="stylesheet">

    <!-- Table CSS -->
    <link href="<c:url value="css/tableStyle.css" />" rel="stylesheet">
